        ...
        l = function (t) {
            if (
                !t
                    ...
                    .filter((t) => "" !== t)
                    .every(
                        (t) => (((t = (t = t.replace(/[#*].*$/, "")).replaceAll(/[()/.*#\s-]+/g, "")).startsWith("+") || t.startsWith("00")) && (t = `+${t.replace(/^[+0]+/, "")}`), !!/^[+]?[0-9]+$/.test(t) && 6 < t.length && t.length < 16)
                    )
            )
                throw new o(this);
        },
        c = function (t) {
            if (
                !t
                    ...
                    .map((t) => t.trim())
                    .filter((t) => "" !== t)
                    .every((t) => !!/^[-]?[0-9]+(?:[eE][+-]?[0-9]+)?$/.test(t) || !!/^[-]?(?:[0-9]+)?[.][0-9]+(?:[eE][+-]?[0-9]+)?$/.test(t))
            )
                throw new o(this);
        },
        m = function (t) {
        ...
        A = function (t) {
            if (
                !t
                    ...
                    .map((t) => t.trim())
                    .filter((t) => "" !== t)
                    .every((t) => !(/^[0-9]{4,}-[0-9]{2}-[0-9]{2}$/.test(t) && /^[0-9]{4,}-[0-9]{2}-[0-9]{2}$/.test(this.threshold) && t < this.threshold))
            )
                throw new o(this);
        },
        z = function (t) {
            if (
                !t
                    ...
                    .map((t) => t.trim())
                    .filter((t) => "" !== t)
                    .every((t) => !(/^[0-9]{4,}-[0-9]{2}-[0-9]{2}$/.test(t) && /^[0-9]{4,}-[0-9]{2}-[0-9]{2}$/.test(this.threshold) && this.threshold < t))
            )
                throw new o(this);
        },
        $ = function (t) {
